    ...
    <div class="painel">
        <form method="POST">
            ...
            <select name="item_escolhido">
                ...
                <option value="espada_simples">🗡 Espada Simples (Arma de mão)</option>
                <option value="espada_longa">🗡️ Espada Longa (Arma de mão)</option>
                <option value="laminas_de_combate">⚔️ Laminas de Combate (Arma de mão)</option>
            </select>
