...
if ($resultado->num_rows > 0){
    ...
    echo "O cliente 'Carlos Silva' não foi encontrado.</br>";
}
...
if($conexao->query($sql) === TRUE){
    echo "Sucesso! O cliente <b>" . $novoNome . "<b/> foi encontrado no banco de dados.</br>";
} else {
...
//Deletar a apartir daqui sem "$conexao->close();".
if($conexao->query($sql) === TRUE){
